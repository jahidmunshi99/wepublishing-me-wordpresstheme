...
if ( ! is_page_template( 'page-templates/wepublishingme-corporate.php' ) ){ 
...
<footer id="colophon" class="site-footer clearfix" role="contentinfo">
	...
	<?php
		...
		if($disable_scroll == 0):?>
	<div class="go-to-top"><a title="<?php esc_attr_e('Go to Top','wepme');?>" href="#masthead"></a></div> <!-- end .go-to-top -->
	<?php endif; ?>
</footer> <!-- end #colophon -->
</div> <!-- end #page -->
<?php wp_footer(); ?>
