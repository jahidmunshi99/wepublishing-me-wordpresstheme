...
<div id="primary">
	...
	<?php global $wepublishingme_settings;
	if( have_posts() ) {
		while( have_posts() ) {
			the_post(); ?>
			...
			<article <?php post_class('post-format'.' format-'.$format); ?><?php  ?> id="post-<?php the_ID(); ?>">
				<?php $featured_image_display = $wepublishingme_settings['wepublishingme_single_post_image'];
					...
					if( has_post_thumbnail()  && $featured_image_display == 'on' ) { ?>
				...
				<?php $entry_format_meta_blog = $wepublishingme_settings['wepublishingme_entry_meta_blog'];
				if($entry_format_meta_blog == 'show-meta' ){?>
					<div class="entry-meta">
						...
						<?php the_author(); ?> </a></span> <span class="posted-on"><?php esc_html_e('Date  :','wepme')?><a title="<?php echo esc_attr( get_the_time() ); ?>" href="<?php the_permalink(); ?>">
						<?php the_time( get_option( 'date_format' ) ); ?> </a></span>
						<?php if ( comments_open() ) { ?>
						<span class="comments"><?php esc_html_e('Comment  :','wepme')?>
							<?php comments_popup_link( __( 'No Comments', 'wepme' ), __( '1 Comment', 'wepme' ), __( '% Comments', 'wepme' ), '', __( 'Comments Off', 'wepme' ) ); ?>
						</span>
						<?php } ?>
					</div> <!-- .entry-meta -->
				<?php } ?>
				...
				<?php if( is_single() ) {
					$tag_list = get_the_tag_list( '', __( ' ', 'wepme' ) );
					...
					<footer class="entry-footer"> <span class="cat-links">
						<?php esc_html_e('Category : ','wepme');  the_category(', '); ?> </span> <!-- .cat-links -->
	...
	<?php 
	 if ( is_single() ) {
		...
		<ul class="default-wp-page clearfix">
			<li class="previous"> <?php previous_image_link( false, __( '&larr; Previous', 'wepme' ) ); ?> </li>
			<li class="next">  <?php next_image_link( false, __( 'Next &rarr;', 'wepme' ) ); ?> </li>
		</ul>
		<?php } else { ?>
		<ul class="default-wp-page clearfix">
			<li class="previous"> <?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'wepme' ) . '</span> %title' ); ?> </li>
			<li class="next"> <?php next_post_link( '%link', '%title <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'wepme' ) . '</span>' ); ?> </li>
		</ul>
			<?php }
					}
	comments_template();
