 ...
 */
 ...
 class wepublishing_services_widget extends WP_Widget{
    ...
    public function widget( $args, $instance ){
        ...
        echo '<!-- Service Widget ============================== -->' . $args[$before_widget] ?>
        <section class="our_feature clearfix">' ?>
                <div class="container_container">
                    ...
                    <p class="feature-sub-title freesia-animation fadeInUp" style="visibility: visible; animation-name: fadeInUp;"><?echo $header_subtitle ?></p>
